...
model.add(SimpleRNN(units=embedding_mat_columns,dropout=0.2))
...
history=model.fit(data, y_train, validation_split=0.4, epochs=3)

model.summary()

trainScore = model.evaluate(data, y_train)
...
with open("models/arabic_sentiment_rnn.pickle", "wb") as f:
    pickle.dump(tokenizer, f)
model.save('models/arabic_sentiment_rnn.hdf5')
